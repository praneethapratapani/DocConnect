...
public final class ActivityDoctorBinding implements ViewBinding {
  ...
  private ActivityDoctorBinding(@NonNull RelativeLayout rootView, @NonNull Button button2,
  ...
  public static ActivityDoctorBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityDoctorBinding((RelativeLayout) rootView, button2, button3, button6,
