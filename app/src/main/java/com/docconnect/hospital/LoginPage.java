package com.docconnect.hospital;
...
import com.docconnect.hospital.user_information.AdminActivity;
import com.docconnect.hospital.user_information.DoctorActivity;
import com.docconnect.hospital.user_information.DoctorSignup;
import com.docconnect.hospital.user_information.PatientActivity;
import com.docconnect.hospital.user_information.PatientSignup;
...
public class LoginPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("DocConnect App");
        ...
        Button signupAdmin = findViewById(R.id.signin_admin);
    ...
    public void navigateToAdminActivity() {
        Intent navigateToAdminIntent = new Intent(LoginPage.this, AdminActivity.class);
        //navigateToPatientIntent.putExtra("patient", patient);

        startActivity(navigateToAdminIntent);
    }
